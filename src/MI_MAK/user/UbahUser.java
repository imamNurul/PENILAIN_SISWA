...
public class UbahUser extends javax.swing.JDialog {
    ...
    public User ubahUser(User param){
        
        txtUsername.setText(param.getUsername());
        txtFullName.setText(param.getFullname());
        txtPass.setText(param.getPassword());
        comboCat.setSelectedItem(param.getCategory());
    ...
    private void initComponents() {
        ...
        panelImageBackground1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Ubah User", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 14))); // NOI18N
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if(txtUsername.getText().trim().isEmpty()){
            ...
            user.setUpdateddate(new java.sql.Timestamp(new java.util.Date().getTime()));
            user.setFlag(1);
