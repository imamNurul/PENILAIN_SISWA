...
public class UbahGuru extends javax.swing.JDialog {
    ...
    public Guru ubahGuru(Guru param, ImageIcon img){
        
        LoadKelasCombo();
        LoadMapelCombo();
        
        if(param.getWaliKelas().equals("Y")){
        ...
        try {
            ...
            txtAlamat.setText(param.getAlamat());
            txtAlamatPhoto.setText(param.getPhoto());
            txtNamaGuru.setText(param.getNama_guru());
            txtNoInduk.setText(param.getNip());
            txtPendTrkhr.setText(param.getPendidikan_terakhir());
            txtTelp.setText(param.getTelp());
            ...
            comboStatus.setSelectedItem(param.getStatus());
            lblID.setText(String.valueOf(param.getId()));
            lblKodeKelas.setText(param.getKd_kelas());
            lblNamaKelas.setText(param.getNm_kelas());
            lblKodeMapel.setText(param.getKd_mapel());
            lblNamaMapel.setText(param.getNm_mapel());
            ...
            comboKelas.setSelectedItem(guru.getKd_kelas()+"-"+guru.getNm_kelas());
            comboMapel.setSelectedItem(guru.getKd_mapel()+"-"+guru.getNm_mapel());
            ...
            Logger.getLogger(UbahGuru.class.getName()).log(Level.SEVERE, null, ex);
        }
        return guru;
    }
    ...
    private void initComponents() {
        ...
        lblKodeMapel.setText("jLabel20");

        lblNamaMapel.setText("jLabel27");

        lblID.setText("jLabel20");

        setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);

        panelImageBackground1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)), "Ubah Guru", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Calibri", 1, 14))); // NOI18N
...
//                }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        if(txtNoInduk.getText().trim().isEmpty()){
            ...
            guru.setId(Integer.parseInt(lblID.getText()));
